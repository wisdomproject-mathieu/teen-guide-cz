// ── SPEECH DATA ──
// 5 tailored speeches per mood-emotion × reason combination
// 1 free + 4 premium per combo
...
const POSITIVE_SPEECHES: Speech[] = [
  ...
  {id:"p-school-4",emo:"positive",reason:["school"],icon:"🧬",title:"Neuroplasticita na tvé straně.",src:"Andrew Huberman",color:T.teal,text:"Huberman říká: každé opakování, každá hodina studia mění strukturu tvého mozku. Doslova. Dneska tvůj mozek rostl. Synapse se posilují. Nejsi stejný člověk jako ráno. Jsi chytřejší."},
  {id:"p-school-5",emo:"positive",reason:["school"],icon:"🏆",title:"Momentum je všechno.",src:"James Clear",color:T.teal,text:"Clear říká: nemusíš být motivovaný. Stačí mít momentum. A dneska ho máš. Ten dobrý pocit ze školy? To je momentum. Neztrácej ho — udělej ještě jednu malou věc navíc. Zítra budeš vděčný."},
  ...
  {id:"p-siblings-4",emo:"positive",reason:["siblings"],icon:"🔗",title:"Bond, co přežije všechno.",src:"Vývojová psychologie",color:T.teal,text:"Studie ukazují, že sourozenecký vztah je nejdelší vztah, co v životě budeš mít. Delší než s rodiči, partnery, kýmkoliv. A dneska ten vztah posilujete. To je investice na 60+ let."},
  {id:"p-siblings-5",emo:"positive",reason:["siblings"],icon:"🎮",title:"Nejlepší co-op hráč.",src:"Motivace",color:T.teal,text:"Život je jako multiplayer hra. A sourozenec je tvůj permanentní co-op partner. Dneska jste synchronizovaní. Užij si ten raid. A nezapomeň — GG je říct nahlas."},
  ...
  {id:"p-parents-4",emo:"positive",reason:["parents"],icon:"🧠",title:"Mirror neurons pracují.",src:"Neurověda",color:T.teal,text:"Tvůj mozek má zrcadlové neurony — doslova kopíruje emoce lidí kolem tebe. Když jsou rodiče v pohodě a ty taky, celá domácnost se synchronizuje. To je biologická harmonie. Vzácná a cenná."},
  {id:"p-parents-5",emo:"positive",reason:["parents"],icon:"📸",title:"Zapamatuj si tenhle den.",src:"Pozitivní psychologie",color:T.teal,text:"Seligman říká: lidé, co si aktivně zapamatovávají dobré momenty, jsou šťastnější. Tohle je jeden z nich. Foťka, zápisek, cokoliv. Za rok budeš rád, že sis to uložil."},
  ...
  {id:"p-friends-4",emo:"positive",reason:["friends"],icon:"🧪",title:"Oxytocin = přírodní droga.",src:"Neurověda",color:T.teal,text:"Když jsi s dobrými kamarády, tvůj mozek produkuje oxytocin — hormon spojení. Je to přírodní antidepresivum. Žádná appka, žádná substance to nenahradí. Tohle je skutečný high."},
  {id:"p-friends-5",emo:"positive",reason:["friends"],icon:"🌍",title:"Tvůj inner circle je všechno.",src:"Jim Rohn",color:T.teal,text:"Rohn říkal: jsi průměrem 5 lidí, se kterými trávíš nejvíc času. A dneska tvůj průměr stoupá. Protože kolem sebe máš lidi, co tě posouvají. Drž se jich."},
  ...
  {id:"p-social-4",emo:"positive",reason:["social"],icon:"🎯",title:"Algoritmus pracuje pro tebe.",src:"Digital Literacy",color:T.teal,text:"Když lajkuješ a sleduješ dobrý obsah, trénuješ algoritmus, aby ti ukazoval víc dobrýho. Dneska jsi ho natrénoval správně. Tvůj feed se mění. A s ním i tvůj mindset."},
  {id:"p-social-5",emo:"positive",reason:["social"],icon:"🔋",title:"Digital balance unlocked.",src:"Adam Alter",color:T.teal,text:"Alter říká: technologie není nepřítel — je to jak ji používáš. A dneska ji používáš jako zdroj energie, ne jako drain. To je skill. Vzácný skill. Buď na sebe pyšný."},
  ...
  {id:"p-identity-4",emo:"positive",reason:["identity"],icon:"🧭",title:"Kompas ukazuje správně.",src:"Viktor Frankl",color:T.teal,text:"Frankl říkal: kdo má proč žít, snese téměř jakékoliv jak. Dneska cítíš ten 'proč'. Ten kompas uvnitř ukazuje správným směrem. Zapamatuj si ten pocit — bude ti sloužit v bouřce."},
  {id:"p-identity-5",emo:"positive",reason:["identity"],icon:"🔥",title:"Vlastní člověk.",src:"Ralph Waldo Emerson",color:T.teal,text:"Emerson říkal: 'Být sám sebou ve světě, který se tě neustále snaží změnit, je největší úspěch.' Dneska jsi dosáhl toho úspěchu. Nejsi kopie nikoho. Jsi originál. A to je power."},
  ...
  {id:"p-lonely-4",emo:"positive",reason:["lonely"],icon:"🔬",title:"Deep work mode.",src:"Cal Newport",color:T.teal,text:"Newport říká: hluboká práce vyžaduje samotu. Nejlepší výsledky vznikají, když vypneš svět. Dneska jsi v deep work mode — i když to tak nenazýváš. Tvůj mozek děkuje."},
  {id:"p-lonely-5",emo:"positive",reason:["lonely"],icon:"🌙",title:"Noční král/královna.",src:"Introverse",color:T.teal,text:"Někteří z nejsilnějších lidí čerpají energii ze samoty. Introverse je superpower, ne handicap. Dneska to cítíš. Ten klid, ta síla — je celá tvoje. Nikdo ti ji nemůže vzít."},
  ...
  {id:"p-other-4",emo:"positive",reason:["other"],icon:"🌈",title:"Důkaz pro špatné dny.",src:"Pozitivní psychologie",color:T.teal,text:"Vezmi si tenhle moment a ulož ho do paměti. Až bude příští špatný den — a bude — vrať se sem. Tohle je tvůj důkaz, že dobré dny existují. A budou zase."},
  {id:"p-other-5",emo:"positive",reason:["other"],icon:"⭐",title:"Dneska jsi hvězda.",src:"Monkey Mind",color:T.teal,text:"Nepotřebuješ důvod být šťastný. Prostě jsi. A to je ta nejlepší forma štěstí — ta, co přijde sama. Bez podmínek. Bez důvodu. Prostě je. Jako ty dneska."},
];
...
const ANGER_SPEECHES: Speech[] = [
  ...
  {id:"a-school-4",emo:"anger",reason:["school"],icon:"🎯",title:"Pomsta úspěchem.",src:"Frank Sinatra",color:T.red,text:"Sinatra říkal: nejlepší pomsta je masivní úspěch. Učitel tě nasral? Systém je neférový? Fajn. Tak buď tak dobrý, že je to umlčí. Každá hodina studia ve vztek je dvojnásobně efektivní."},
  {id:"a-school-5",emo:"anger",reason:["school"],icon:"💪",title:"Discipline beats talent.",src:"Jocko Willink",color:T.red,text:"Jocko říká: disciplína porazí talent. Pokaždé. Jsi naštvaný na školu? Dobře. Přeměň ten vztek na disciplínu. Udělej věci, které ostatní neudělají. A pak se podívej, kdo se směje nakonec."},
  ...
  {id:"a-siblings-4",emo:"anger",reason:["siblings"],icon:"🎭",title:"Oni ti nastavují zrcadlo.",src:"Carl Jung",color:T.red,text:"Jung říkal: to, co nás na druhých nejvíc štve, je často to, co nechceme vidět sami na sobě. Sourozenec je tvoje zrcadlo. A zrcadlo občas ukazuje nepříjemné věci. Ale právě proto je cenné."},
  {id:"a-siblings-5",emo:"anger",reason:["siblings"],icon:"⚔️",title:"Konflikt = trénink.",src:"Psychologie",color:T.red,text:"Každá hádka se sourozencem je trénink na budoucí vztahy. Učíš se řešit konflikty, stanovovat hranice, odpouštět. To jsou skills, co ti budou sloužit celý život. I když to teď sere."},
  ...
  {id:"a-parents-4",emo:"anger",reason:["parents"],icon:"🔄",title:"Generační cyklus.",src:"Gabor Maté",color:T.red,text:"Maté říká: rodiče nevědomky opakují vzorce, ve kterých vyrostli. Neomlouvá to nic — ale vysvětluje to hodně. Tvůj vztek je oprávněný. A zároveň — ty ten cyklus můžeš přerušit."},
  {id:"a-parents-5",emo:"anger",reason:["parents"],icon:"📝",title:"Napiš, co nemůžeš říct.",src:"Journaling",color:T.red,text:"Někdy nemůžeš říct rodičům, co cítíš. Tak to napiš. Ne jim — sobě. Vylejí se z tebe slova, která potřebuješ slyšet. A pak? Možná jim to jednou ukážeš. Nebo ne. Ale tebe to uvolní."},
  ...
  {id:"a-friends-4",emo:"anger",reason:["friends"],icon:"🛡️",title:"Hranice jsou zdravé.",src:"Nedra Tawwab",color:T.red,text:"Tawwab říká: hranice nejsou zeď — jsou brána. Propouští lidi, kteří tě respektují. Vztek na kamaráda je signál, že tvá brána byla porušena. Posílit ji není sobectví — je to self-care."},
  {id:"a-friends-5",emo:"anger",reason:["friends"],icon:"💎",title:"Kvalita > kvantita.",src:"Motivace",color:T.red,text:"Nepotřebuješ 100 followerů. Potřebuješ 3 lidi, kterým můžeš zavolat v 2 ráno. Pokud ten, kdo tě nasral, není jeden z nich — proč mu dáváš tolik moci nad tvými emocemi?"},
  ...
  {id:"a-social-4",emo:"anger",reason:["social"],icon:"🧪",title:"Dopaminová past.",src:"Anna Lembke",color:T.red,text:"Lembke říká: tvůj mozek je teď v dopaminovém dluhu. Sociální sítě ti daly spike, a teď padáš. Vztek je withdrawal symptom. Polož telefon na 30 minut. Mozek se vyrovná. Slibuji."},
  {id:"a-social-5",emo:"anger",reason:["social"],icon:"🌿",title:"Analog je nový luxus.",src:"Digital Wellness",color:T.red,text:"Víš co je dnes nejdražší? Pozornost. A sociální sítě ti ji kradou. Každý vztek na online drama je minuta, kterou jsi mohl strávit v realitě. Jdi ven. Dotkni se stromu. Cítíš ten rozdíl?"},
  ...
  {id:"a-identity-4",emo:"anger",reason:["identity"],icon:"🏋️",title:"Vztek je surová energie.",src:"Tony Robbins",color:T.red,text:"Robbins říká: emoce jsou akce signály. Vztek na sebe říká: 'Chci být lepší.' To není slabost — to je ambice. Přeměň ten vztek v akční plán. Co konkrétně změníš? Začni malým krokem."},
  {id:"a-identity-5",emo:"anger",reason:["identity"],icon:"🔨",title:"Koho buduješ?",src:"Nietzsche",color:T.red,text:"Nietzsche říkal: 'Člověk musí mít v sobě chaos, aby mohl porodit tančící hvězdu.' Ten chaos uvnitř tebe — ten vztek, ta frustrace — to je surovina. Co z ní postavíš?"},
  ...
  {id:"a-lonely-4",emo:"anger",reason:["lonely"],icon:"🐺",title:"Samotářský vlk.",src:"Motivace",color:T.red,text:"Někteří z nejsilnějších lidí byli samotáři. Tesla. Nikola. Kafka. Nebyli zlomení — byli před svou dobou. Tvůj vztek na osamělost? To je vlk, co chce běžet. Tak běž. Kmen tě najde."},
  {id:"a-lonely-5",emo:"anger",reason:["lonely"],icon:"🌋",title:"Erupce je přirozená.",src:"Psychologie",color:T.red,text:"Potlačený vztek je jako potlačená sopka — jednou vybuchne. Lepší je řízeně vypustit páru. Napiš to. Vykřič to do polštáře. Běž si zaběhat. Dej tomu formu — a ztrácí to moc nad tebou."},
  ...
  {id:"a-other-4",emo:"anger",reason:["other"],icon:"🥊",title:"Shadow boxing.",src:"Carl Jung",color:T.red,text:"Jung říkal: dokud si neuděláš ze svého stínu vědomého partnera, bude řídit tvůj život a ty tomu budeš říkat osud. Ten vztek? To je tvůj stín. Podívej se mu do očí. Co ti říká?"},
  {id:"a-other-5",emo:"anger",reason:["other"],icon:"🌊",title:"Surfuj na vlně.",src:"Tara Brach",color:T.red,text:"Brach říká: RAIN — Recognize, Allow, Investigate, Nurture. Rozpoznej vztek. Dovol mu být. Prozkoumej ho — kde v těle ho cítíš? A pak se k sobě chovej laskavě. Vztek není nepřítel. Je to messenger."},
];
...
const SADNESS_SPEECHES: Speech[] = [
  ...
  {id:"sd-school-4",emo:"sadness",reason:["school"],icon:"🧩",title:"Selhání je feedback.",src:"Thomas Edison",color:T.blue,text:"Edison říkal: 'Neselhal jsem. Jen jsem našel 10 000 způsobů, které nefungují.' Špatná známka není konec — je to data. Co ti říká? Kde můžeš zlepšit? Smutek přejde. Lekce zůstane."},
  {id:"sd-school-5",emo:"sadness",reason:["school"],icon:"🌱",title:"Semínka pod sněhem.",src:"Motivace",color:T.blue,text:"Pod sněhem rostou semínka, i když nic nevidíš. Tvůj mozek teď zpracovává všechno, co se učíš — i když to tak necítíš. Smutek ze školy je zimní sníh. Jaro přijde. A budeš překvapený, co vyroste."},
  ...
  {id:"sd-siblings-4",emo:"sadness",reason:["siblings"],icon:"🕊️",title:"Odpuštění je dar sobě.",src:"Desmond Tutu",color:T.blue,text:"Tutu říkal: odpuštění není pro toho druhého — je pro tebe. Držet smutek a vztek na sourozence je jako pít jed a čekat, že ublíží jemu. Odpusť. Ne pro ně. Pro sebe. Pro svůj klid."},
  {id:"sd-siblings-5",emo:"sadness",reason:["siblings"],icon:"🌅",title:"Ráno bude jinak.",src:"Motivace",color:T.blue,text:"Vztahy se sourozenci mají cykly. Dneska je špatný den. Ale vzpomeň si na dobrý den — existoval, ne? A bude zase. Cykly se opakují. A ty jsi dost silný, aby ses dočkal dalšího dobrého cyklu."},
  ...
  {id:"sd-parents-4",emo:"sadness",reason:["parents"],icon:"🏗️",title:"Stavíš vlastní cestu.",src:"Khalil Gibran",color:T.blue,text:"Gibran říkal: 'Vaše děti nejsou vaše děti. Přišly skrze vás, ale ne od vás.' Ty jsi vlastní bytost. Smutek z rodičů je součástí oddělování se. A to je přirozené. Bolestivé, ale přirozené."},
  {id:"sd-parents-5",emo:"sadness",reason:["parents"],icon:"🌿",title:"Emoce nejsou slabost.",src:"Gabor Maté",color:T.blue,text:"Maté říká: potlačené emoce se projeví jinak — v těle, v chování, v návycích. Tvůj smutek z rodičů potřebuje prostor. Dej mu ho. Pláč, deník, procházka — cokoliv. Ale nepotlačuj to."},
  ...
  {id:"sd-friends-4",emo:"sadness",reason:["friends"],icon:"🧵",title:"Přátelství jsou jako tkaniny.",src:"Psychologie",color:T.blue,text:"Některá vlákna se přetrhnou. Ale tkanina zůstává. Ztráta jednoho kamaráda neznamená ztrátu schopnosti mít kamarády. Tvoje schopnost tvořit spojení je nedotčená. Jen potřebuje čas na zhojení."},
  {id:"sd-friends-5",emo:"sadness",reason:["friends"],icon:"🌱",title:"Z bolesti roste moudrost.",src:"Rumi",color:T.blue,text:"Rumi říkal: 'Rána je místo, kudy do tebe vstupuje světlo.' Ta bolest z kamaráda tě učí, co chceš a co nechceš. Co toleruješ a co ne. Za rok budeš moudřejší. A tvoje nová přátelství budou silnější."},
  ...
  {id:"sd-social-4",emo:"sadness",reason:["social"],icon:"🪟",title:"Okno vs. zrcadlo.",src:"Digital Literacy",color:T.blue,text:"Sítě by měly být okno do světa, ne zrcadlo pro srovnávání. Když scrolluješ a je ti smutno, používáš je jako zrcadlo. Zavři appku. Otevři skutečné okno. Podívej se ven. Svět je větší než screen."},
  {id:"sd-social-5",emo:"sadness",reason:["social"],icon:"🎯",title:"Unfollowni smutek.",src:"Cal Newport",color:T.blue,text:"Newport říká: tvůj feed je tvoje prostředí. Pokud tě prostředí dělá smutným, změň ho. Unfollowni účty, co tě stahují dolů. Followni ty, co tě zvedají. Jednoduchá rovnice. Udělej to teď."},
  ...
  {id:"sd-identity-4",emo:"sadness",reason:["identity"],icon:"🎭",title:"Všichni nosí masku.",src:"Motivace",color:T.blue,text:"Víš kdo další neví, kdo je? Všichni kolem tebe. Každý se tváří, že má jasno — ale nikdo nemá. Tvůj smutek z nejistoty tě dělá lidským. A to je přesně to, co máš být."},
  {id:"sd-identity-5",emo:"sadness",reason:["identity"],icon:"🧭",title:"Ztracený = na cestě.",src:"J.R.R. Tolkien",color:T.blue,text:"Tolkien říkal: 'Ne všichni, kdo bloudí, jsou ztraceni.' Ty teď bloudíš. Ale to neznamená, že jsi ztracený. Znamená to, že hledáš cestu. A cesta se ukazuje tomu, kdo má odvahu jít."},
  ...
  {id:"sd-lonely-4",emo:"sadness",reason:["lonely"],icon:"📱",title:"Jeden krok do světa.",src:"Psychologie",color:T.blue,text:"Nemusíš najít 10 kamarádů. Stačí jeden. A stačí jedna zpráva. Napiš někomu, koho znáš. 'Jak se máš?' Dva slova. Většina spojení začíná takhle malými kroky. Zkus to."},
  {id:"sd-lonely-5",emo:"sadness",reason:["lonely"],icon:"🌙",title:"Tma je dočasná.",src:"Viktor Frankl",color:T.blue,text:"Frankl přežil koncentrák v naprosté izolaci. Říkal: 'Kdo má proč, snese téměř jakékoliv jak.' Tvoje osamělost je jak — ne proč. Najdi své proč. A jak se stane snesitelným."},
  ...
  {id:"sd-other-4",emo:"sadness",reason:["other"],icon:"☕",title:"Malá radost.",src:"Hygge",color:T.blue,text:"Dáni mají koncept hygge — malé, útulné radosti. Udělej si čaj. Pusť si oblíbenou hudbu. Zabal se do deky. Nemusíš řešit svět — stačí řešit příštích 10 minut. A udělat je hezké."},
  {id:"sd-other-5",emo:"sadness",reason:["other"],icon:"🌿",title:"Příroda léčí.",src:"Shinrin-yoku",color:T.blue,text:"Japonci mají shinrin-yoku — 'koupel v lese'. Studie ukazují, že 20 minut v přírodě snižuje kortizol o 12%. Nemusíš do lesa — stačí park, zahrada, strom za oknem. Příroda je antidepresivum. Zadarmo."},
];
...
const ANXIETY_SPEECHES: Speech[] = [
  ...
  {id:"x-school-4",emo:"anxiety",reason:["school"],icon:"🧊",title:"Ledová sprcha na mozek.",src:"Wim Hof",color:T.orange,text:"Hof říká: studená voda resetuje nervový systém. Nemůžeš dát studenou sprchu teď? Stačí ledová voda na zápěstí na 30 sekund. Vagusový nerv se aktivuje. Úzkost klesne. Vyzkoušej to."},
  {id:"x-school-5",emo:"anxiety",reason:["school"],icon:"📊",title:"Katastrofické myšlení je lhář.",src:"CBT",color:T.orange,text:"Tvůj mozek říká: 'Nezvládnu to. Propadnu. Bude to katastrofa.' Zapiš si ty myšlenky. A pak se zeptej: je to fakt, nebo interpretace? Většina školní úzkosti je interpretace. Ne realita."},
  ...
  {id:"x-siblings-4",emo:"anxiety",reason:["siblings"],icon:"🔊",title:"Řekni to nahlas.",src:"Psychoterapie",color:T.orange,text:"Úzkost miluje ticho. Krmí se nevyřčenými věcmi. Zkus říct nahlas, co tě trápí — sám sobě, do zrcadla, do telefonu. Když to slyšíš svým hlasem, najednou to zní jinak. Menší. Zvládnutelnější."},
  {id:"x-siblings-5",emo:"anxiety",reason:["siblings"],icon:"🏰",title:"Tvůj prostor je tvůj.",src:"Hranice",color:T.orange,text:"Pokud sourozenec narušuje tvůj prostor a cítíš úzkost — máš právo na hranice. Zavřít dveře není sobectví. Říct 'teď potřebuju být sám' není útok. Je to self-care. A je to tvoje právo."},
  ...
  {id:"x-parents-4",emo:"anxiety",reason:["parents"],icon:"🎯",title:"Rozlišuj fakta a pocity.",src:"DBT",color:T.orange,text:"DBT říká: emoce nejsou fakta. Cítíš, že rodiče tě nemají rádi? To je pocit. Fakt je: bydlíš, jíš, mluví s tebou. Pocity lžou. Ne vždycky — ale dost často na to, abys je nekontroloval bez prověření."},
  {id:"x-parents-5",emo:"anxiety",reason:["parents"],icon:"🕐",title:"This too shall pass.",src:"Perské přísloví",color:T.orange,text:"Staré perské přísloví: 'I tohle přejde.' Říká se, že tenhle nápis měl na prstenu král Šalamoun. V dobrých časech ho učil pokoře, v zlých časech mu dával naději. Tvoje úzkost z rodičů přejde."},
  ...
  {id:"x-friends-4",emo:"anxiety",reason:["friends"],icon:"🧩",title:"Imposter syndrome.",src:"Psychologie",color:T.orange,text:"Cítíš, že do party nepatříš? Imposter syndrome postihuje 70% lidí. Včetně těch 'sebevědomých' kolem tebe. Ty tam patříš. Tvůj mozek jen hraje starý záznam, který už není aktuální."},
  {id:"x-friends-5",emo:"anxiety",reason:["friends"],icon:"🌿",title:"Sociální přestávka je OK.",src:"Introverse",color:T.orange,text:"Nemusíš být na každé akci. Nemusíš odpovídat na každou zprávu okamžitě. Sociální přestávka není odmítnutí — je to dobíjení. Řekni: 'Potřebuju chvilku.' Správní lidi to pochopí."},
  ...
  {id:"x-social-4",emo:"anxiety",reason:["social"],icon:"⏰",title:"Screen time = anxiety time.",src:"Jean Twenge",color:T.orange,text:"Twenge prokázala přímou korelaci: víc hodin na sociálních sítích = víc úzkosti. Každá hodina navíc = +10% riziko. Sniž o 30 minut denně. Za týden budeš cítit rozdíl. Vyzkoušej to."},
  {id:"x-social-5",emo:"anxiety",reason:["social"],icon:"🧘",title:"Mindful scrolling.",src:"Digital Mindfulness",color:T.orange,text:"Než otevřeš appku, zeptej se: proč ji otevírám? Z nudy? Ze zvyku? Z úzkosti? Pokud odpověď není 'protože chci' — zavři ji. Mindful scrolling = scrolluj jen když to chceš, ne když to 'musíš'."},
  ...
  {id:"x-identity-4",emo:"anxiety",reason:["identity"],icon:"🔬",title:"Existenciální úzkost je zdravá.",src:"Irvin Yalom",color:T.orange,text:"Yalom říká: existenciální úzkost — 'kdo jsem?' 'proč jsem tady?' — je znak inteligence. Zvířata ji nemají. Jen lidé s hlubokým myšlením. Tvoje úzkost je důkaz hloubky. Ne slabosti."},
  {id:"x-identity-5",emo:"anxiety",reason:["identity"],icon:"🎨",title:"Identita se tvoří, ne nachází.",src:"Psychologie",color:T.orange,text:"Přestaň 'hledat' kdo jsi. Začni 'tvořit' kdo jsi. Identita není schovaný poklad — je to umělecké dílo. Ty jsi malíř. A plátno je prázdné. To není děsivé — to je svoboda."},
  ...
  {id:"x-lonely-4",emo:"anxiety",reason:["lonely"],icon:"🌐",title:"Online kmen existuje.",src:"Digital Community",color:T.orange,text:"Nemáš kmen offline? Existuje online. Discord, Reddit, fóra — miliony lidí hledají spojení. Najdi komunitu kolem toho, co tě baví. Hry, umění, hudba — cokoliv. Tvůj kmen existuje. Hledej."},
  {id:"x-lonely-5",emo:"anxiety",reason:["lonely"],icon:"🐕",title:"Malé kroky ke spojení.",src:"Sociální psychologie",color:T.orange,text:"Nemusíš najít soulmate. Stačí začít mikrointerakcí. Úsměv na prodavačku. Pozdrav souseda. Komentář pod postem. Každá mikrointerakce snižuje úzkost ze samoty o kousek. Malé kroky. Velká změna."},
  ...
  {id:"x-other-4",emo:"anxiety",reason:["other"],icon:"🌡️",title:"Body scan.",src:"Jon Kabat-Zinn",color:T.orange,text:"Kabat-Zinn říká: skenuj tělo od hlavy k patě. Kde cítíš napětí? Čelo? Ramena? Žaludek? Zaměř se na to místo. Nadechni se do něj. Vydechni napětí. Opakuj. Tělo je tvůj GPS pro úzkost."},
  {id:"x-other-5",emo:"anxiety",reason:["other"],icon:"❄️",title:"Cold exposure hack.",src:"Wim Hof",color:T.orange,text:"Studená voda na obličej aktivuje 'dive reflex' — okamžitě snižuje tepovou frekvenci. Dej si studenou vodu na zápěstí nebo obličej. Za 30 sekund budeš klidnější. Biologie > panika."},
];
...
const GENERIC_SPEECHES: Speech[] = [
  ...
  {id:"g4",emo:"all",reason:[],icon:"🌅",title:"Každý den je restart.",src:"Motivace",color:T.orange,text:"Nezáleží na včerejšku. Nezáleží na tom, co se pokazilo. Dneska je nový den. Nový restart. A ty máš 24 hodin na to, aby se něco změnilo. Co uděláš s první hodinou?"},
  {id:"g5",emo:"all",reason:[],icon:"🔥",title:"Jsi silnější, než si myslíš.",src:"Monkey Mind",color:T.orange,text:"Přežil jsi 100% svých nejtěžších dní. Stoprocentní úspěšnost. A dneska? Dneska není výjimka. Tohle je další den, co přežiješ. A zítra na něj budeš pyšný."},
];
