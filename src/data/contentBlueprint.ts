...
export const CONTENT_BLUEPRINT: ContentItem[] = [
  ...
  },
  {
    ...
    title: "Watch next: rise when life hits hard",
    access: "free",
    ...
    intensity: [2, 3],
    durationSeconds: 540,
    tags: ["youtube", "hero", "external"],
    hook: "Jedno silné free video jako ochutnávka, když potřebuješ slyšet, že dno může být začátek.",
    sourceKind: "curated_embed",
    embedUrl: "https://www.youtube.com/watch?v=TkQHzcozv4k",
    chatPrompt: "Dokoukal jsem to video a fakt se mě to dotklo. Jsem teď dole a potřebuju pomoct převést ten pocit do konkrétního dalšího kroku.",
